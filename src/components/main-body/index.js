    ...
    <main className="bg-white flex flex-col min-h-screen pt-16">
      <div className="px-4 pt-8 md:px-8 lg:px-16 xl:px-32 ">
        <div className="max-w-lg mx-auto">
          <h1 className="text-3xl font-bold text-center text-black mb-4 flex flex-col md:flex-row items-center justify-center">
            Download Image
            <span className="text-3xl ml-2 md:ml-0">Google Docs</span>
          </h1>
          ...
          >
            ...
            />
            <div className="text-xs text-center text-gray-700 mb-4 mt-4">
